...
public class TestLocators {
    ...
    public void testSetElementValue() {
        ...
        try {
            ...
            Assertions.assertThat(e.getLocalizedMessage()).containsPattern("Can't set page component 'com.braimanm.ui.auto.test.GooglePage.search2' to value: github page-component");
        }
    }
